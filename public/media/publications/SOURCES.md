...
| `sodor.png` | Figure 2, https://arxiv.org/html/2412.15598v1/method.png (CC BY 4.0) |

The CELM entry cites the latest arXiv preprint (three authors). Its separate ICLR
2026 Workshop on Multimodal Intelligence version has an additional author,
Xihao Piao. The public venue label is shortened to ICLR 2026 at the team's
request; the supporting record is the workshop version, not main-conference
proceedings. It is not listed as a NeurIPS publication.
